...
using TPanel.Api.Auth;
using TPanel.Api.Spa;
using TPanel.Application;
using TPanel.Application.Common.Interfaces;
using TPanel.Infrastructure;
...
builder.Services.AddSingleton<TPanel.Infrastructure.Services.IWebHostEnvironmentMarker>(
...
app.UseMiddleware<TPanel.Api.Middleware.MerchantApiAuthMiddleware>();
...
file sealed class WebHostEnvironmentMarker(string contentRootPath)
    : TPanel.Infrastructure.Services.IWebHostEnvironmentMarker
{
