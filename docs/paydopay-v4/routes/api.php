...
use App\Http\Controllers\Api\BankAccountReportController;
...
Route::middleware(['auth:sanctum', 'idle.timeout'])->group(function () {
    ...
    Route::get('/reports/bank-account-analysis', [BankAccountReportController::class, 'analysis']);
    ...
    Route::post('/settings/anthropic/test', [SettingsController::class, 'testAnthropic']);
    Route::post('/settings/anthropic/analyze-test', [SettingsController::class, 'analyzeTestReceipt']);
    ...
    Route::get('/withdrawals/receipt-review', [WithdrawController::class, 'receiptReview']);
    ...
    Route::post('/withdrawals/{id}/receipts/{rid}/manual-verify', [WithdrawController::class, 'manualVerifyReceipt']);
    Route::post('/withdrawals/{id}/receipts/{rid}/flag-fake', [WithdrawController::class, 'flagFakeReceipt']);
    Route::post('/withdrawals/notify-missing-receipts', [WithdrawController::class, 'notifyMissingReceipts']);
